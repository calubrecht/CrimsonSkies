...
const struct cmd_type cmd_table[] = {
    ...
    {"guild",     do_guild,     POS_DEAD,     L7, LOG_ALWAYS, 1},
...
/*  {"bug",       do_bug,       POS_DEAD,     0, LOG_NORMAL, 1}, */
    ...
    {"bladesong",       do_bladesong,   POS_FIGHTING, 0, LOG_NORMAL, 0},
    ...
    {"class",           do_class,       POS_SLEEPING, 0, LOG_NORMAL, 1},
    ...
    {"memory",          do_memory,      POS_DEAD, L3, LOG_NORMAL, 1},
    ...
    {"wizbless",        do_wizbless,    POS_DEAD, IM, LOG_ALWAYS, 1},
